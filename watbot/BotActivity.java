        ...
        Thread thread = new Thread(new Runnable(){
            public void run() {
                try {
                    ...
                    service.setUsernameAndPassword("2601db8b-49da-4e1c-8427-39198055c90e", "yNCnQKKkZwxn");
                    MessageRequest newMessage = new MessageRequest.Builder().inputText(inputmessage).context(context).build();
                    MessageResponse response = service.message("cd827f8d-f6d3-427b-919a-b98e555be581", newMessage).execute();
